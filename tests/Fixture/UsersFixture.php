...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2021-06-05 10:15:05',
                'modified' => '2021-06-05 10:15:05',
            ],
        ];
        parent::init();
    }
